...
class DBHelper {
  ...
  static Future<void> initDb() async {
    if (_db != null) { //если БД не null, значит она уже была иннициализирована
      return;
    }
    try {
    ...
    } catch (e) { //если что-то пойдет не так, выведем ошибку на экран
      print(e);
    }
  }
  ...
  static update_my_task(Task? task) async {
    print("update_my_task function called");
    return await _db!.rawUpdate('''
      UPDATE task
      SET id = ?, title =?, note = ?, date = ?, startTime = ?, repeat  =?, isCompleted = ?
