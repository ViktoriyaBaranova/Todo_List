...
class _HomePageState extends State<HomePage>{
  ...
  _showBottom(BuildContext context, Task task){
    Get.bottomSheet(
      Container(
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children:[
                _bottomIcon(label: Icon(Icons.event_available_rounded, size: 45,),
              onTap: (){
              ...
              context: context, ),
                ...
                _bottomIcon(label: Icon(Icons.edit, size: 45,),
              onTap: () async{
                print("*******Edit***");
              ...
              context: context, ),
                _bottomIcon(label: Icon(Icons.delete, size: 45,),
              onTap: (){
  ...
  _bottomIcon({required Icon label,required Function()? onTap, required Color clr,bool isClose=false, required BuildContext context}){
